...
\autoref{fig:rlmpc-final} displays the final results of the mentioned implementations. Although providing a terminal region contributes the most to the performance gains, the addition of the value function can further enhance performance, albiet at the cost of increased computational time.
